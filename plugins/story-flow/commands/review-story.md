...
2. Then: `review-story-against-ticket` if it exists (project-level - overrides/extends the plugin)
3. Confirm which skills are loaded before continuing with the review.
