...
- Report findings with specific examples of what's missing, incomplete, or misaligned. List every finding first, then discuss one at a time, applying each to the story markdown once the developer confirms it.
