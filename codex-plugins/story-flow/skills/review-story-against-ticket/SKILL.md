...
- Report findings with specific examples of what's missing, incomplete, or misaligned. List every finding first, then work through them one at a time with explanation, applying each to the story markdown once the developer confirms it.
